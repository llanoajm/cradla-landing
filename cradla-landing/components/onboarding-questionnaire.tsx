...
const OnboardingQuestionnaire = () => {
  ...
  return (
    <section className="py-16 px-0 relative z-[0] mt-[-80] mb-20 w-full">
      <div className="w-full bg-white shadow-xl overflow-hidden">
        {/* Gradient header */}
        <div className="bg-white p-8 text-black">
          <p className="text-3xl md:text-4xl font-bold max-w-3xl mx-auto">See if you're a match with Cradla's on-demand therapy style.</p>
          <p className="mt-3 opacity-90 text-lg md:text-xl max-w-3xl mx-auto">Answer a few questions to see if Cradla's on-demand therapy approach is right for you. Takes less than 2 minutes.</p>
          <p className="max-w-3xl mx-auto">💬 Join 500+ people already on our waitlist.</p>
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    className="bg-gradient-to-r from-[#BFC261] to-[#DE3163] h-2 rounded-full" 
                  ...
                  <div className="space-y-3">
                    {questions[step].options.map((option) => (
                      <button
                        ...
                        className="w-full text-left p-4 border border-gray-200 rounded-lg hover:border-[#BFC261] hover:bg-gray-50 transition-all flex justify-between items-center"
                      >
                ...
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <button 
                      ...
                      className="w-full py-3 bg-gradient-to-r from-[#BFC261] to-[#DE3163] text-white font-bold rounded-lg hover:opacity-90 transition-opacity"
                    >
              ...
              >
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button 
                    ...
                    className="bg-gradient-to-r from-[#BFC261] to-[#DE3163] border-0"
                  >
